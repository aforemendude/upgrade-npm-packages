...
import {
  ...
  ALLOW_SYMLINKS_ARGUMENT,
  FORCE_REINSTALL_ARGUMENT,
  NO_COLOR_ARGUMENT,
} from './parse-cli-arguments';
...
export const getHelpMessage = (): string =>
  [
    ...
    '',
    'Options:',
    `  ${ALLOW_DIRTY_ARGUMENT}      Allow upgrades when the Git worktree has uncommitted changes`,
